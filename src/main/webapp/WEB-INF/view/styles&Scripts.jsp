...
<head>
  ...
  <link rel="stylesheet" href="${pageContext.request.contextPath}/assets/web/assets/prime-icons/prime-icons.css">
  ...
  <link rel="stylesheet" href="${pageContext.request.contextPath}/assets/animatecss/animate.min.css">
  ...
  <link rel="stylesheet" href="${pageContext.request.contextPath}/assets/prime/css/mbr-additional.css" type="text/css">
  <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/assets/prime/css/3.3.7.bootstrap.min.css">
  <!--<link rel="stylesheet" type="text/css" href="assets/prime/css/font-awesome.min.css">-->
