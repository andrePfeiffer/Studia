...
<div class="container" style="margin-top:40px; margin-left:0px;">
    ...
    <c:if test="${tipoComponente == 'material'}">
	    <div class="col-md-7"> 
	            <div class="right-content-bg">
	                ...
	                <div id="conteudoAula">
	                	...
	                	<br>
						<a href="${pageContext.request.contextPath}/material/${material.arquivo}" target="_blank">PDF</a>
	                </div>
	                <br><br><br>
	            </div>
	    </div>
    </c:if>
    <c:if test="${tipoComponente == 'exercicio'}">
	    <div class="col-md-7"> 
	            <div class="right-content-bg">
	                <h3>${componente.titulo}</h3>
	                ...
	                <div id="conteudoAula">
	                	${componente.descricao}
	                	<br>
						<a href="#">Enviar solução</a>
	                </div>
	                <br><br><br>
	            </div>
	    </div>
    </c:if>
    <c:if test="${tipoComponente == 'video'}">
	    <div class="col-md-7"> 
	            <div class="right-content-bg">
	                <h3>${componente.titulo}</h3>
	                ...
	                <div id="conteudoAula">
	                	...
	                	<br>
	                	<video controls>
	                		<source src="${pageContext.request.contextPath}/video/${video.arquivo}" type="video/mp4">
	                	</video>
	                </div>
	                <br><br><br>
	            </div>
